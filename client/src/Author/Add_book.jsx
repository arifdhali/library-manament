...
const Add_book = () => {
    ...
    const handleAddbookSubmit = async (e) => {
        ...
        try {
            const response = await axios.post("http://localhost:4000/author/add-books/", formData, {
                headers: {
                            ...
                            <div className="mt-10 grid grid-cols-1 gap-4 sm:grid-cols-6">
                                ...
                                <div className="col-span-full">
                                    ...
                                    <div className="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10">
                                        {addBook.thumbnail && (
                                            <img src={URL.createObjectURL(addBook.thumbnail)} alt="Uploaded Thumbnail" className="w-full max-h-64" />
                                        )}
